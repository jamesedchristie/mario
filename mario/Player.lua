...
function Player:checkFinish()
    if self.map:finish(self.map:tileAt(self.x + self.width, self.y)) or
            self.map:finish(self.map:tileAt(self.x + self.width, self.y + self.height - 1)) then
